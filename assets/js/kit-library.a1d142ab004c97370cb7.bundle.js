...
function FilterIndicationText(props) {
  ...
  }, (0, _i18n.sprintf)(__('Showing %s Results For', 'elementor'), props.resultCount), ' ', props.queryParams.search && "\"".concat(props.queryParams.search, "\""), ' ', selectedTaxonomies.length > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, selectedTaxonomies.map(function (taxonomy) {
...
function ItemHeader(props) {
  ...
  var apply = (0, _react.useCallback)(function () {
    $e.data.get('kits/download-link', {
      ...
      var data = _ref2.data;
      return navigate("/import/process?file_url=".concat(data.data.download_link, "&nonce=").concat(data.meta.nonce, "&referrer=kit-library"));
    }).catch(function () {
...
function useKits() {
  ...
  var _useState3 = (0, _react.useState)(function () {
    return (0, _objectSpread3.default)((0, _objectSpread3.default)({}, defaultQueryParams), initialQueryParams);
  }),
      _useState4 = (0, _slicedToArray2.default)(_useState3, 2),
  ...
  var clearQueryParams = (0, _react.useCallback)(function () {
    return setQueryParams((0, _objectSpread3.default)((0, _objectSpread3.default)({}, defaultQueryParams), initialQueryParams));
  }, [setQueryParams]);
...
var _indexNoResults = _interopRequireDefault(__webpack_require__(/*! ../index/index-no-results */ "../core/app/modules/kit-library/assets/js/pages/index/index-no-results.js"));
...
function Favorites(props) {
  ...
  var indexNotResultsFavorites = /*#__PURE__*/_react.default.createElement(_indexNoResults.default, {
...
function IndexNoResults(props) {
  ...
  }, props.description, /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement(_appUi.Button, {
...
function useRouterQueryParams(queryParams, setQueryParams) {
  ...
  (0, _react.useEffect)(function () {
    var routerQueryParams = wp.url.getQueryArgs(location.pathname);
    setQueryParams(function (prev) {
      return (0, _objectSpread3.default)((0, _objectSpread3.default)((0, _objectSpread3.default)({}, prev), routerQueryParams), {}, {
        taxonomies: (0, _objectSpread3.default)((0, _objectSpread3.default)({}, prev.taxonomies), routerQueryParams.taxonomies)
      });
    });
  }, []);
}
...
function Index(props) {
  ...
  useRouterQueryParams(queryParams, setQueryParams, (0, _keys.default)(props.initialQueryParams));
  ...
  }, /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, isLoading && __('Loading...', 'elementor'), isError && __('An error occurred', 'elementor'), isSuccess && 0 < data.length && /*#__PURE__*/_react.default.createElement(_kitList.default, {
    data: data
  }), isSuccess && 0 === data.length && props.renderNoResultsComponent({
    defaultComponent: /*#__PURE__*/_react.default.createElement(_indexNoResults.default, {
...
//# sourceMappingURL=kit-library.a1d142ab004c97370cb7.bundle.js.map